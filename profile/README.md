# Welcome to AIMMS Open Source Hub!

At AIMMS, we empower teams to optimize their world. This GitHub organization is our central hub for sharing practical examples, comprehensive documentation, and developer tools to help you build powerful prescriptive analytics applications.

## 📊 Featured Projects & KPIs
We monitor these projects closely to ensure our community has the best resources. Here is the current engagement and documentation for our featured models:
...
| **[Vessel Scheduling](https://github.com/aimms/vessel-scheduling)** | [![Downloads](https://img.shields.io/github/downloads/aimms/vessel-scheduling/total?style=for-the-badge&logo=github&labelColor=000081&color=1847c9)](https://github.com/aimms/vessel-scheduling/releases) | [Read Article](https://how-to.aimms.com/Articles/590/590-vessel-scheduling.html) |
...
Need help or want to improve our tools?
* **[AIMMS Community](https://community.aimms.com):** The best place for modeling advice and technical discussions.
* **Contribute:** Found a bug or have an improvement? Let us know or push a change! You are invited to help us grow.



## 📚 Master AIMMS (Knowledge Hub)

Everything you need to go from beginner to expert, all in one place:

* **[AIMMS E-Learning](https://elearning.aimms.com/):** Structured video courses and certifications (now with subtitles in 7 languages!).
* **[Documentation](https://documentation.aimms.com):** Detailed technical manuals and language references.
* **[How-to](https://how-to.aimms.com):** Practical articles and step-by-step guides for specific use cases.
